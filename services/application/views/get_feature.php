<wfs:FeatureCollection
 ...
 xsi:schemaLocation='<?php echo base_url(); ?>
    <?php echo base_url('wfs/write_xml'); ?>?service=WFS&amp;version=1.0.0&amp;request=DescribeFeatureType&amp;Typename=<?php echo str_replace(" ", "-", $feat->SiteName); ?>
...
<gml:boundedBy><gml:null>missing</gml:null></gml:boundedBy>
	<gml:featureMember>
		<<?php echo str_replace(" ", "-", $feat->SiteName); ?>>
			...
			<tows:watermlurl><?php echo $watermlurl; ?></tows:watermlurl>
			...
			<tows:geom><gml:Point srsName="EPSG:<?php echo $feat->SiteID; ?>"><gml:coordinates><?php echo $feat->Longitude . ',' . $feat->Latitude; ?></gml:coordinates></gml:Point></tows:geom>
		</<?php echo str_replace(" ", "-", $feat->SiteName); ?>>
	</gml:featureMember>
</wfs:FeatureCollection>
