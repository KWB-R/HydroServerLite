...
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <p><strong>This system is running HydroServer Lite <?php echo "$HSLversion"; ?> and your database contains <?php echo "$num_sites"; ?> Sites, <?php echo "$num_datapts"; ?> data points, <?php echo "$num_vars"; ?> Variables, and <?php echo "$num_u"; ?> users.</strong></p>
