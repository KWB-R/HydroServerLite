...
alert("The Censor Code is a controlled vocabulary used to define whether the data value is censored.");
}
...
<table width="800" border="0" align="center" style="background-color: #FFFFFF;">
  ...
  <tr>
    <td>&nbsp;</td>
    <td>Censor Code: </td>
    <td><input type="text" id="Censor Code" name="censorcode" value="" />&nbsp;<a href="#" onClick="show_answerCC()" border="0"><img src="../images/questionmark.png" border="0"></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>Quality Control Level: </td>
    <td><input type="text" id="Quality Control Level" name="qcl" value="" />&nbsp;<a href="#" onClick="show_answerQCL()" border="0"><img src="../images/questionmark.png" border="0"></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>Value Accuracy: </td>
    <td><input type="text" id="Value Accuracy" name="valueacc" value="" />&nbsp;<a href="#" onClick="show_answerVA()" border="0"><img src="../images/questionmark.png" border="0"></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>Offset Type ID:</td>
    <td><input type="text" id="Offset Type ID" name="offsettype" value="" />&nbsp;<a href="#" onClick="show_answerOTID()" border="0"><img src="../images/questionmark.png" border="0"></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>Qualifier ID: </td>
    <td><input type="text" id="Qualifier ID" name="qualifier" value="" />&nbsp;<a href="#" onClick="show_answerQ()" border="0"><img src="../images/questionmark.png" border="0"></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>Sample ID: </td>
    <td><input type="text" id="sampleid" name="sampleid" value="" />&nbsp;<a href="#" onClick="show_answerSID()" border="0"><img src="../images/questionmark.png" border="0"></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>Derived From ID: </td>
    <td><input type="text" id="Derived from ID" name="derived" value="" />&nbsp;<a href="#" onClick="show_answerDFID()" border="0"><img src="../images/questionmark.png" border="0"></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
