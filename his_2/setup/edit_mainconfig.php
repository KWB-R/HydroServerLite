...
<link rel="bookmark" href="../client/favicon.ico" >

<link href="../client/styles/main_css.css" rel="stylesheet" type="text/css" media="screen" />
...
<body background="../client/images/bkgrdimage.jpg">
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="2"><img src="../client/images/WebClientBanner.png" width="960" height="200" alt="Adventure Learning Banner" /></td>
  </tr>
...
<table width="800" border="0" align="center" style="background-color: #FFFFFF;">
  ...
  <tr>
    ...
    <td width="416"><input type="text" id="Database Host" name="databasehost" value="" />&nbsp;<a href="#" onClick="show_answerDH()" border="0"><img src="../client/images/questionmark.png" border="0"></a></td>
    </tr>
  <tr>
    <td width="19">&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td>Database Name: </td>
    <td><input type="text" id="Database Name" name="databasename" value="" />&nbsp;<a href="#" onClick="show_answerDN()" border="0"><img src="../client/images/questionmark.png" border="0"></a></td>
    </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td><input type="text" id="Profile Version" name="profilev" value="" />&nbsp;<a href="#" onClick="show_answerPV()" border="0"><img src="../client/images/questionmark.png" border="0"></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td>Local X:</td>
    <td><input type="text" id="localx" name="localx" value="" />&nbsp;<a href="#" onClick="show_answerLX()" border="0"><img src="../client/images/questionmark.png" border="0"></a></td>
    </tr>
  <tr>
    <td>&nbsp;</td>
    <td>Local Y:</td>
    <td><input type="text" id="localy" name="localy" value="" />&nbsp;<a href="#" onClick="show_answerLY()" border="0"><img src="../client/images/questionmark.png" border="0"></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>Local Projection ID:</td>
    <td><input type="text" id="localpid" name="localpid" value="" />&nbsp;<a href="#" onClick="show_answerLPID()" border="0"><img src="../client/images/questionmark.png" border="0"></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>PosAccuracy_m:</td>
    <td><input type="text" id="posaccuracy" name="posaccuracy" value="" />&nbsp;<a href="#" onClick="show_answerPA()" border="0"><img src="../client/images/questionmark.png" border="0"></a></td>
  </tr>
  <tr>
    <td width="19">&nbsp;</td>
    <td>Vertical Datum:&nbsp;</td>
    <td><input type="text" id="Vertical datum" name="vdatum" value="" />&nbsp;<a href="#" onClick="show_answerVD()" border="0"><img src="../client/images/questionmark.png" border="0"></a></td>
  </tr>
  <tr>
    <td width="19">&nbsp;</td>
    <td> Spatial Reference: </td>
    <td><input type="text" id="Spatial Reference" name="spatialref" value="" />&nbsp;<a href="#" onClick="show_answerSR()" border="0"><img src="../client/images/questionmark.png" border="0"></a></td>
  </tr>
  <tr>
    <td width="19">&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td>Variable Code: </td>
    <td><input type="text" id="Variable Code" name="varcode" value="" />&nbsp;<a href="#" onClick="show_answerVC()" border="0"><img src="../client/images/questionmark.png" border="0"></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td> Time Support: </td>
    <td><input type="text" id="Time Support" name="timesupport" value=""/>&nbsp;<a href="#" onClick="show_answerTS()" border="0"><img src="../client/images/questionmark.png" border="0"></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td width="19">&nbsp;</td>
    <td>UTCOffset: </td>
    <td><input type="text" id="UTC Offset" name="utcoffset1" value="" />&nbsp;<a href="#" onClick="show_answerUTC1()" border="0"><img src="../client/images/questionmark.png" border="0"></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>UTCOffset 2: </td>
    <td><input type="text" id="UTC Offset 2" name="utcoffset2" value="" />&nbsp;<a href="#" onClick="show_answerUTC2()" border="0"><img src="../client/images/questionmark.png" border="0"></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>Censor Code: </td>
    <td><input type="text" id="Censor Code" name="censorcode" value="nc" />&nbsp;<a href="#" onClick="show_answerCC()" border="0"><img src="../client/images/questionmark.png" border="0"></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>Quality Control Level: </td>
    <td><input type="text" id="Quality Control Level" name="qcl" value="0" />&nbsp;<a href="#" onClick="show_answerQCL()" border="0"><img src="../client/images/questionmark.png" border="0"></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>Value Accuracy: </td>
    <td><input type="text" id="Value Accuracy" name="valueacc" value="NULL" />&nbsp;<a href="#" onClick="show_answerVA()" border="0"><img src="../client/images/questionmark.png" border="0"></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>Offset Type ID:</td>
    <td><input type="text" id="Offset Type ID" name="offsettype" value="NULL" />&nbsp;<a href="#" onClick="show_answerOTID()" border="0"><img src="../client/images/questionmark.png" border="0"></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>Qualifier ID: </td>
    <td><input type="text" id="Qualifier ID" name="qualifier" value="1" />&nbsp;<a href="#" onClick="show_answerQ()" border="0"><img src="../client/images/questionmark.png" border="0"></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>Sample ID: </td>
    <td><input type="text" id="sampleid" name="sampleid" value="NULL" />&nbsp;<a href="#" onClick="show_answerSID()" border="0"><img src="../client/images/questionmark.png" border="0"></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>Derived From ID: </td>
    <td><input type="text" id="Derived from ID" name="derived" value="NULL" />&nbsp;<a href="#" onClick="show_answerDFID()" border="0"><img src="../client/images/questionmark.png" border="0"></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
