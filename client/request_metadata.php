...
$option_block_emdata = "<table width='600' border='0' cellspacing='0' cellpadding='0'>
		<tr>
          <td width='130' valign='top'><strong>Metadata ID #:</strong></td>
          <td valign='top' width='470'><input type='text' name='MetadataID2' id='MetadataID2' size='5' value='$MetadataID2' disabled>&nbsp;<span class='em'>(You may not edit this.)</span></td>
        </tr>
        <tr>
          <td valign='top'>&nbsp;</td>
          <td valign='top'>&nbsp;</td>
...
$option_block_emdata .= "<td valign='top'>$option_block_tc &nbsp;<span class='em'>(You may select Unknown)</span></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td valign='top'><input type='text' id='Title2' name='Title2' value='$Title2' size='25' maxlength='200'/>*&nbsp;<span class='em'>(Ex: McCall Outdoor Science School Cyberlearning)</span></td>
          </tr>
        <tr>
          <td valign='top'>&nbsp;</td>
          <td width='22' valign='top'>&nbsp;</td>
        ...
        <tr>
          ...
          <td valign='top'><input type='text' id='ProfileVersion2' name='ProfileVersion2' value='$ProfileVersion2' size='12' maxlength='200'/>*&nbsp;<a href='#' onClick='show_answer()' border='0'><img src='images/questionmark.png' border='0'></a>&nbsp;<span class='em'>(Ex: ISO8601; Or you may enter Unknown)</span></td>
          </tr>
        <tr>
          <td valign='top'>&nbsp;</td>
          <td valign='top'>&nbsp;</td>
