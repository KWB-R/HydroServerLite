...
$option_block_emdata = "<table width='600' border='0' cellspacing='0' cellpadding='0'>
		<tr>
		  ...
		  <td width='130' valign='top'><strong>$MetadataId</strong></td>
          <td valign='top' width='470'><input type='text' name='MetadataID2' id='MetadataID2' size='5' value='$MetadataID2' disabled>&nbsp;<span class='em'>$NoEdit</span></td>
        </tr>
        <tr>
          <td valign='top'>&nbsp;</td>
          <td valign='top'>&nbsp;</td>
