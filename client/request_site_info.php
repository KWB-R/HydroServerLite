...
$option_block_esite .= "<tr>
          ...
          <td width='557'><input type='text' id='SiteName' name='SiteName' value='$SiteName' size='20' maxlength='200' />*&nbsp;<span class='em'>(Ex: Boulder Creek at Jug Mountain Ranch)</span></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr>
          ...
          <td><input type='text' id='SiteCode' name='SiteCode' value='$SiteCode' size=20 maxlength='200'/>*&nbsp;<a href='#' onClick='show_answerSC()' border='0'><img src='images/questionmark.png' border='0'></a><span class='em'></span></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
...
//Pull the Site Type data for the dropdown menu
	$option_block_st = "<select name='SiteType' id='SiteType' value='$SiteType' onChange='TrainingAlert()'>
...
//Pull the Vertical Datum data for the dropdown menu
	...
	<option value='$VerticalDatum'>$VerticalDatum</option>
	<option value='-1'>Select....</option>";
...
$option_block_esite .= "<td>$option_block_sr*</td>
  ...
  <tr>
    ...
    <td><input type='text' id='com' name='value' size='50' maxlength='500' value='$Comments'/>
