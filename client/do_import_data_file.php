...
$newUTCpiece = ($timepieces[0] + $UTCOffset2); 
	...
	if ($newUTCpiece > 24) {
		...
		$newUTCtime = "0" . $NewTimePiece . ":" . $timepieces[1]. ":" . $pieces3[2]; 

		$DP0 = $pieces[0]; // piece1 (year as YYYY)
		$DP1 = $pieces[1]; // piece2 (month as MM)
		$DP2 = $pieces2[0]; // piece3 (day as DD)
	...
	$NewDay = 01;
		...
		$DateTimeUTC = $NewYear . "-" . $NewMonth . "-" . $NewDay . " " . $newUTCtime;
		}
	...
	$DateTimeUTC = $pieces[0]."-".$pieces[1]."-".$pieces2[0]. " " . $newUTCpiece . ":" . $timepieces[1] . ":" . $pieces3[2];
	}
