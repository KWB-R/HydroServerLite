...
<p><strong><a name="Register"></a>How do I register for an account, so I can enter data?</strong><br>
          Creating an account 
        must be done by your program coordinator. Please contact them to fulfill this request.</p>
...
<p><strong><a name="DeleteValues" id="Bug4"></a>Can I delete values if I realize I entered something incorrectly?</strong><br>
   If you enter a value  that is incorrect or needs to be changed, please contact your program coordinator immediately. They have the authority  needed to edit or delete the  data from the table.</p>
...
<p><strong><a name="Questions"></a>Still have questions?</strong><br>
        If you do not see your question or  answer you're seeking, please contact your program coordinator about these additional  questions.</p>
