	...
	<div id="statusmsg"><p class=em2><?php echo $DataEnteredSuccessfully;?>
      ...
      <table width="450" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="370" valign="top"><select name="SourceID" id="SourceID" onChange="showSites(this.value)"><option value="-1"><?php echo $SelectEllipsis; ?></option><?php echo "$option_block"; ?></select><span class="required">*</span></td>
          </tr>
        <tr>
          <td valign="top">&nbsp;</td>
          <td valign="top">&nbsp;</td>
        ...
        <tr>
          ...
          <td valign="top"><div id="txtHint"><select name="SiteID" id="SiteID"><option value="-1"><?php echo $SelectEllipsis; ?></option></select><span class="required">*</span><span class="hint" title="<?php echo "'". $IfNoSeeSite1."'";?>  + <?php echo "'". $ContactSupervisor."'";?> + <?php echo "'". $AddIt."'";?>">?</span></div></td>
          </tr>
        <tr>
          <td valign="top">&nbsp;</td>
          <td valign="top">&nbsp;</td>
      ...
      <table width="600" border="1" cellpadding="0" cellspacing="0" id="multiple">
        <tr>
          <td width="182"><center><strong><?php echo $Variable;?>&nbsp;*</strong></center></td>
          <td width="249"><center><strong><?php echo $Method;?>&nbsp;*</strong>&nbsp;<span class="hint" title="<?php echo "'". $IfNoSeeMethod1."'";?> + <?php echo "'". $ContactSupervisor."'";?> + <?php echo "'". $AddIt."'";?>">?</span></center></td>
          <td width="60"><center><strong><?php echo $Date;?>&nbsp;*</strong>&#8224;</center></td>
          <td width="46"><center><strong><?php echo $Time;?>&nbsp;</strong>&#8224;</center></td>
          <td width="51"><center><strong><?php echo $Value;?>&nbsp;</strong>&#8224;</center></td>
          </tr>
        <tr>
