...
<br /><p class="em" align="right"><!--Required fields are marked with an asterick (*).--><?php echo $RequiredFieldsAsterisk;?></p>
      <h1><?php echo $ChangeYourPassword;?></h1>
      <p>&nbsp;</p>
      <FORM METHOD="POST" ACTION="change_yourpassword.php" name="change_yourpassword">
       ...
       <tr>
        ...
        <tr>
		  ...
		  <td valign="top"><strong><?php echo $NewPassword1; ?></strong></td>
