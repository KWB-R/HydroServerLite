...
<p class="em" align="right"><?php echo getTxt('RequiredFieldsAsterisk'); ?></p><?php echo getTxt('msg'); ?></p>
	      <h1><?php echo getTxt('AddNewUser'); ?></h1>
      <p>&nbsp;</p>
      <FORM METHOD="POST" ACTION="do_adduser.php" name="newuser">
      <table width="600" border="0" cellspacing="0" cellpadding="0">
        <tr>
		  <td width="95" valign="top"><strong><?php echo getTxt('FirstName'); ?></strong></td>
        ...
        <tr>
		  <td width="95" valign="top"><strong><?php echo getTxt('LastName'); ?></strong></td>
        ...
        <tr>
          ...
          <div class="em"></div></td>
		  <td valign="top"><span class="em"><span id="user-result"></span><span class="required">*</span><?php echo getTxt('FirstLastNameExample'); ?></span></td>
        </tr>
        <tr>
          <td valign="top">&nbsp;</td>
          <td valign="top">&nbsp;</td>
        ...
        <tr>
		  <td width="95" valign="top"><strong><?php echo getTxt('Password'); ?></strong></td>
          <td valign="top"><input type="text" name="password" maxlength=25 id ="password"/><div class="em"></div></td>
          <td valign="top"><span class="em"><span class="required">*</span><?php echo getTxt('CaseSensitive'); ?></span></td>
        </tr>
        <tr>
          <td valign="top">&nbsp;</td>
          <td valign="top">&nbsp;</td>
        ...
        <tr>
		  <td width="95" valign="top"><strong><?php echo getTxt('Authority'); ?> </strong></td>
        ...
        <tr>
          <td width="95" valign="top"><input type="SUBMIT" name="submit" value="<?php echo getTxt('AddUser');?>" class="button"/></td>
          <td valign="top"><input type="reset" name="Reset" value="<?php echo getTxt('Cancel'); ?>" class="button" style="width: auto" /></td>
          <td valign="top">&nbsp;</td>
        </tr>
      </table></FORM>
	  <p><br>
