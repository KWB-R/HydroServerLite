...
<title><?php echo getTxt('WebClient'); ?></title>
...
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<td width="240" valign="top" bgcolor="#f2e6d6"><?php echo getTxt('nav'); ?></td>
    <td width="720" valign="top" bgcolor="#FFFFFF"><blockquote><br />
      <!--<h1>Import a Data File</h1>-->
      <h1><?php echo getTxt('Import'); ?></h1><?php echo getTxt('msg'); ?>&nbsp;<?php echo getTxt('msg3'); ?>&nbsp;
      ...
      <p><?php echo getTxt('MustConform'); ?></p>
      <p>LocalDateTime,DataValue<br>
        ...
        <a href="sample_csv.txt" target="_blank"><?php echo getTxt('ViewSample'); ?></a></p>
      <!--<p>If your file is prepared correctly, you may use the process below:<div id="statusmsg">-->
      <p><?php echo getTxt('PreparedCorrectly'); ?><div id="statusmsg">
      
        <p class=em2><?php echo getTxt('Success');?>
          <input type="button" name="viewdata" id="viewdata" value="<?php echo getTxt('View'); ?>" />
        <input type="button" name="viewdata2" id="viewdata2" value="<?php echo getTxt('More'); ?>" />
        </p>
     </div>
     <FORM METHOD="POST" ACTION="" name="addvalue" id="addvalue">
       <table width="500" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td valign="top"><select name="SourceID" id="SourceID" onChange="showSites(this.value)"><option value="-1"><?php echo getTxt('SelectEllipsis'); ?></option><?php echo "$option_block"; ?></select></td>
          </tr>
        <tr>
          <td valign="top">&nbsp;</td>
          <td valign="top">&nbsp;</td>
        ...
        <tr>
          ...
          <td valign="top"><div id="txtHint"><select name="SiteID" id="SiteID"><option value="-1"><?php echo getTxt('SelectEllipsis'); ?></option></select>&nbsp;<a href="#" onClick="show_answer()" border="0"><img src="<?php echo getImg('questionmark.png'); ?>" border="0"></a></div></td>
        ...
        <tr>
          ...
          <td width="55" valign="top"><strong><?php echo getTxt('Type'); ?></strong></td>
          <td width="370" valign="top"><select name="VariableID" id="VariableID" onChange="showMethods(this.value)">
            <option value="-1"><?php echo getTxt('SelectEllipsis'); ?></option><?php echo "$option_block3"; ?></select></td>
          </tr>
        <tr>
          <td valign="top">&nbsp;</td>
          <td valign="top">&nbsp;</td>
        ...
        <tr>
          ...
          <td valign="top"><div id="txtHint2"><select name="MethodID" id="MethodID"><option value="-1"><?php echo getTxt('SelectEllipsis'); ?></option></select>&nbsp;<a href="#" onClick="show_answer2()" border="0"><img src="<?php echo getImg('questionmark.png'); ?>" border="0"></a></div></td>
          </tr>
        <tr>
          <td valign="top">&nbsp;</td>
        ...
        <tr>
          <td colspan="2" valign="top"><strong><?php echo getTxt('UploadCSV');?></strong></td>
          </tr>
        <tr>
  ...
  <input id="pickfiles" name="selfile" type="button" value="<?php echo getTxt('SelectFile'); ?>">
  <input id="uploadfiles" name="upfile" type="button" value="<?php echo getTxt('Upload'); ?>">
          </div></td>
          </tr>
        <tr>
          <td valign="top">&nbsp;</td>
        ...
        <tr>
          ...
          <td valign="top">
           <input name="Button" type="button" class="button" id="submit1" value="<?php echo getTxt('SubmitData'); ?>" style="width: 135px"/>
