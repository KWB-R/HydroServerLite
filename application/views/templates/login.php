...
<div id="loginHolder">
    ...
    <div class="col-sm-9 col-md-offset-3"><p class="h3"><strong><?php echo getTxt('LoginButton');?></strong></p></div>
	<!--<ul class="login">-->
		<!--<li><label><?php echo getTxt('UserName');?></label><input type="text" id="username" name="username"></li>-->
        <div class="form-group"><div class="col-sm-9"><input type="text" id="username" name="username" class="form-control input-sm chat-input" placeholder="<?php echo getTxt('UserName');?>" /></div></div>
        </br>
		<!--<li><label><?php echo getTxt('Password');?></label><input type="password" id="password" name="password"></li>-->
        <div class="form-group"><div class="col-sm-9"><input type="password" id="password" name="password" class="form-control input-sm chat-input" placeholder="<?php echo getTxt('Password');?>" /></div></div>
        </br>
