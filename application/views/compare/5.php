...
var url=base_url+"series/getDateJSON?siteid="+$("#siteidc").val()+"&varid=" + $("#varidc").val()+"&methodid=" + $("#methodidc").val();
$.ajax({
    type: "GET",
	url: url,
	dataType: "json",
...
var date_from=String(result.BeginDateTime);
var date_to=String(result.EndDateTime);		
...
$('#daterangec').prepend('<p><strong>'+<?php echo "'".getTxt('DatesAvailable')."'";?>+'</strong> ' + date_from + ' <strong>'+<?php echo "'".getTxt('To')."'";?>+'</strong> ' + date_to +'</p>');
...
var url_test=base_url+'datapoint/getData?siteid='+$("#siteidc").val()+'&varid='+$("#varidc").val()+'&meth='+$("#methodidc").val()+'&startdate='+$("#fromc").val()+'&enddate='+$("#toc").val();
$.ajax({
  url: url_test,
  type: "GET",
  dataType: "script"
...
<table width="630" border="0">
        ...
        <tr>
          <td colspan="4"><?php echo getTxt('EnterDateRange');?></td>
        </tr>
        <tr>
          <td width="67">&nbsp;</td>
          <td width="239"></td>
        ...
        <tr>
          <td colspan="2"><div id='c_fromdrop'><div>
                <?php echo getTxt('FromDate');?></div>
            <div id="jqxDateTimeInputc">
               
            </div></div></td>
          <td colspan="2"><div id='c_todrop'>
          <div>
                <?php echo getTxt('ToDate');?></div>
          ...
          <tr>
          <td>&nbsp;</td>
          <td> <input type="button" value="<?php echo getTxt('PlotAll');?>" id='all' /></td>
          <td>&nbsp;</td>
          <td> <input type="button" value="<?php echo getTxt('PlotSelectedRange');?>" id='selected' /></td>
        </tr>
      </table>
