...
*/
	...
	<p class="em" align="right"><?php echo getTxt('RequiredFieldsAsterisk'); ?></p><?php echo getTxt('msg'); ?>
      <h1><?php echo getTxt('RemoveExistingUser'); ?></h1>
 
      <p>&nbsp;</p>
      <FORM METHOD="POST" ACTION="do_removeuser.php">
        <table width="300" border="0" cellspacing="0" cellpadding="0">
        <tr>
           <td width="100" valign="top"><strong><?php echo getTxt('UserName'); ?></strong></td>
          <td width="200" valign="top"><select name="username" id="username"><option value=""><?php echo getTxt('SelectUsernameEllipisis'); ?></option><?php echo "$option_block"; ?></select><span class="required">*</span></td>
        </tr>
        <tr>
        ...
        <tr>
          <td valign="top">&nbsp;</td>
          <td valign="top"><input type="SUBMIT" name="submit" value="<?php echo getTxt('RemoveUser');?>" class="button" style="width: auto" /></td>
