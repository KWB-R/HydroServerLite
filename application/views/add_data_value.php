...
<br /><p class="em" align="right"><span class="requiredInstructions"><?php echo getTxt('RequiredFieldsAsterisk'); ?> </span></p><?php echo getTxt('msg'); ?>&nbsp;<?php echo getTxt('msg3'); ?>&nbsp;<?php echo getTxt('msg4'); ?>
        <div id="msg"><p class=em2><?php echo getTxt('ValueSuccessfully'); ?></p></div>
        <h1><?php echo getTxt('EnterSingleDataValue'); ?></h1>
        <p>&nbsp;</p>
      <FORM METHOD="POST" ACTION="" name="addvalue" id="addvalue">
        <table width="600" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td valign="top"><strong><!--Source:--> <?php echo getTxt('Source'); ?></strong></td>
          <td valign="top"><select name="SourceID" id="SourceID" onChange="showSites(this.value)"><option value="-1"><!--Select....--><?php echo getTxt('SelectEllipsis'); ?></option><?php echo "$option_block"; ?></select><span class="required">*</span></td>
          </tr>
        <tr>
          <td valign="top">&nbsp;</td>
          <td valign="top">&nbsp;</td>
        ...
        <tr>
          ...
          <td valign="top"><div id="txtHint"><select name="SiteID" id="SiteID"><option value="-1"><?php echo getTxt('SelectElipsis'); ?></option></select><span class="required">*</span><span class="hint" title="If you do not see your <?php echo getTxt('__Site->Capitalized'); ?> listed here, please contact your supervisor and ask them to add it before entering data.">?</span></div> 
</td>
          </tr>
        <tr>
          <td valign="top">&nbsp;</td>
        ...
        <tr>
          <td width="55" valign="top"><strong><?php echo getTxt('Variable'); ?></strong></td>
          <td width="370" valign="top"><select name="VariableID" id="VariableID" onChange="showMethods(this.value)"><option value="-1"><?php echo getTxt('SelectElipsis'); ?></option><?php echo "$option_block3"; ?></select><span class="required">*</span></td>
          </tr>
        <tr>
          <td valign="top">&nbsp;</td>
          <td valign="top">&nbsp;</td>
        ...
        <tr>
          <td valign="top"><strong><?php echo getTxt('Method'); ?>:</strong></td>
          <td valign="top"><div id="txtHint2"><select name="MethodID" id="MethodID"><option value="-1"><?php echo getTxt('SelectElipsis'); ?></option></select><span class="required">*</span><span class="hint" title="<?php echo "'". getTxt('IfNoSeeMethod1')."'";?> + '\n' + <?php echo "'". getTxt('ContactSupervisor')."'";?> + '\n' + <?php echo "'". getTxt('AddIt')."'";?>"></span></div></td>
          </tr>
        <tr>
          <td valign="top">&nbsp;</td>
        ...
        <tr>
          <td width="55" valign="top"><strong><!--Date:--><?php echo getTxt('Date'); ?></strong></td>
          <td valign="top"><input type="text" id="datepicker" name="datepicker" onChange="return validateDate()"><span class="required">*</span><span class="em"><?php echo getTxt('DateFormatExample'); ?></span></td>
          </tr>
        <tr>
          <td valign="top">&nbsp;</td>
          <td valign="top">&nbsp;</td>
        ...
        <tr>
          <td width="55" valign="top"><strong><!--Time:--><?php echo getTxt('Time'); ?></strong></td>
          <td valign="top"><input type="text" id="timepicker" name="timepicker" onChange="return validateTime()" class="short"><span class="required">*</span><span class="em"><?php echo getTxt('TimeFormatExample'); ?></span></td>
          </tr>
        <tr>
          <td valign="top">&nbsp;</td>
          <td valign="top">&nbsp;</td>
        ...
        <tr>
          <td width="55" valign="top"><strong><?php echo getTxt('Value'); ?></strong></td>
          <td valign="top"><input type="text" id="value" name="value" class="short" maxlength=20 onBlur="return validateNum()"/><span class="required">*</span><span class="em"><?php echo getTxt('NumberNoCommas'); ?></span></td>
          </tr>
        <tr>
          <td valign="top">&nbsp;</td>
          <td valign="top">&nbsp;</td>
        ...
        <tr>
          ...
          <td valign="top"><input type="SUBMIT" name="submit" value= "<?php echo getTxt('SubmitData'); ?>" class="button" style="width: auto" />&nbsp;&nbsp;<input type="reset" name="Reset" value="<?php echo getTxt('Cancel'); ?>" class="button" style="width: auto" /></td>
          </tr>
      </table>
    </FORM></p>
      <p>&nbsp;</p>
