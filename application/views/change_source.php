...
<br /><?php echo getTxt('msg'); ?><p class="em" align="right"><?php echo getTxt('RequiredFieldsAsterisk');?></p><div id="msg">
      <p class=em2><?php echo getTxt('SourceMetadataDeleted');?></p></div>
    <div id="msg2">
      <p class=em2><?php echo getTxt('SourceEdited');?></p></div>
      <h1><?php echo getTxt('EditDeleteSource');?></h1>
      <p><?php echo getTxt('SelectSource');?></p>
        ...
        <tr>
          <td colspan="3" valign="top"><strong class="em2"><?php echo getTxt('NoteColon');?></strong> <span class="em"><?php echo getTxt('NoteText');?></span></td>
          </tr>
        <tr>
