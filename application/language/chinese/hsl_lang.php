<?php
 ...
 $lang['hsl_UTCOffsetInfo'] = "明确的时间日期格式需要说明时区或与国际标准时间的差值（UTCOffset），UTCOffset可以确保数据库中记录的时间可以转换为统一标准时间，进而可以对不同时区采集的数据进行对比。例如，McCall Idaho是山区标准时间（MST），因此数值为-7。";
 $lang['hsl_UTCOffset2Info'] = "为了自动校准日期与时间，需要在软件中输入另一个UTC值进行计算，为第一个UTC值取负。例如，McCall Idaho是山区标准时间（MST），因此数值为7。";
 ...
 $lang["db_The Site Code is a unique identifier used by an organization that collects the data. For example, if the organization\\\'s name was McCall Outdoor Science Center and the name of the site was Boulder Creek at Jug Mountain Ranch, then your Site Code could be MOSS-BC-JMR"] = "场地代码是由数据采集单位设定的识别代码。例如，如果单位名称是McCall Outdoor Science Center，场地名称是位于Boulder Creek的Jug Mountain Ranch，则场地代码可以设定为MOSS-BC-JMR";
 ...
 $lang['hsl_AddNewMethod'] = "添加新方法";
 $lang['hsl_ExampleMethodName'] = "（例如：YSI DO 250<1米）";
 $lang['hsl_SelectVariablesBelow1'] = "请选择通过此方法获得的变量：";
 $lang['hsl_AddMethodButton'] = "添加方法";
 $lang['hsl_ValueSuccessfully'] = "数据成功添加！";
 $lang['hsl_EnterSingleDataValue'] = "输入一个数据";
 $lang['hsl_DateFormatExample'] = "（YYYY-MM-DD格式，例如：2012年5月4日填写“ 2012-05-04”）";
 $lang['hsl_TimeFormatExample'] = "（HH:MM, 24小时制，例如：下午1:45填写13:45）";
 $lang['hsl_NumberNoCommas'] = "（必须为数字，无逗号）";
 $lang['hsl_SelectSource'] = "请选择数据源！";
 $lang['hsl_AddSource'] = "添加数据源";
 $lang['hsl_ChangeSource'] = "修改数据源";
 $lang['hsl_ChangeSite'] = "修改场地";
 $lang['hsl_AddVariable'] = "添加变量";
 $lang['hsl_ChangeVariable'] = "修改变量";
 $lang['hsl_AddMethod'] = "添加方法";
 $lang['hsl_ChangeMethod'] = "修改方法";
 $lang['hsl_ChangeUsersAuthority'] = "修改用户";
 $lang['hsl_RemoveUser'] = "删除用户";
 $lang['hsl_ToSearch'] = "若要查找场地，请输入所在城市，或点击“查找附近场地！”显示以您的地理位置为中心、300英里为半径范围内的场地。（备注：不包含数据的场地将不显示。）";
 $lang['hsl_NotFound'] = "没有找到";
 $lang['hsl_ClickHereDetails'] = "点击此处查看场地详细信息与数据";
 $lang['hsl_FailTemp'] = "临时目录打开失败！";
 $lang['hsl_FailInputStream'] = "输入流打开失败！";
 $lang['hsl_FailOutputStream'] = "输出流打开失败！";
 $lang['hsl_FailMoveFile'] = "上传文件移动失败！";
 $lang['hsl_InvalidHeading'] = "无效列标题。标题必须为以下格式：";
 $lang['hsl_InvalidTime'] = "“本地日期时间”行存在无效字符";
 $lang['hsl_InvalidYear'] = "日期行存在无效年";
 $lang['hsl_InvalidMonth'] = "日期行存在无效月";
 $lang['hsl_InvalidDay'] = "日期行存在无效日";
 $lang['hsl_ErrorDate'] = "日期格式错误在行";
 $lang['hsl_InvalidHour'] = "时间行存在无效小时";
 $lang['hsl_InvalidMin'] = "时间行存在无效分钟";
 $lang['hsl_InvalidSec'] = "时间行存在无效秒";
 $lang['hsl_InvalidChar'] = "数据行存在无效字符";
 $lang['hsl_PleaseFix'] = "，请修正错误并重新上传CSV文件";
 $lang['hsl_Error'] = "SQL查询执行错误";
 $lang['hsl_TeacherNavigation'] = "教师导航";
 $lang['hsl_StudentNavigation'] = "学生导航";
 $lang['hsl_SrcID'] = "数据源ID#：";
 $lang['hsl_ToChange'] = "如果修改，您可以手动输入经度/纬度/高程，或点击地图上位置获取（可通过拖动地图上图标调整点至精确位置）。";
 $lang['hsl_MethodId'] = "方法ID#：";
 $lang['hsl_ExMethodName'] = "（例如：YSI DO 200米）";
 $lang['hsl_PublicNavigation'] = "公共导航";
 $lang['hsl_BackHome'] = "返回首页";
 $lang['hsl_InstallationComplete'] = "安装完成";
 $lang['hsl_CongratsInstall'] = "恭喜！您已经成功安装HydroServer Interactive，点击下一步去您的场地。";
 $lang['hsl_Login'] = "您可以用上一页设定的管理员密码登录，用户名为“his_admin”（无双引号）";
 $lang['hsl_GoToSite'] = "去场地";
 $lang["db_Average"] = "平均";
 $lang["db_The values represent the average over a time interval, such as daily mean discharge or daily mean temperature."] = "此数据显示在一定时间段内平均值，如每日平均排放或每日平均温度。";
 $lang["db_Best Easy Systematic Estimator"] = "Best Easy Systematic Estimator";
 $lang["db_Best Easy Systematic Estimator BES = Q1 +2Q2 +Q3)/4. Q1, Q2, and Q3 are first, second, and third quartiles. See Woodcock, F. and Engel, C., 2005: Operational Consensus Forecasts.Weather and Forecasting, 20, 101-111. http://www.bom.gov.au/nmoc/bulletins/60/article_by_Woodcock_in_Weather_and_Forecasting.pdf) and Wonnacott, T. H., and R. J. Wonnacott, 1972: Introductory Statistics. Wiley, 510 pp."] = "Best Easy Systematic Estimator BES = Q1 +2Q2 +Q3)/4，Q1、Q2、Q3为第一、第二、第三四分位数。参考Woodcock, F.和Engel, C., 2005：Operational Consensus Forecasts.Weather and Forecasting, 20, 101-111. http://www.bom.gov.au/nmoc/bulletins/60/article_by_Woodcock_in_Weather_and_Forecasting.pdf)，以及Wonnacott, T. H.和R. J. Wonnacott, 1972：Introductory Statistics. Wiley, 510 pp.";
 $lang["db_Categorical"] = "分类";
 $lang["db_The values are categorical rather than continuous valued quantities. Mapping from Value values to categories is through the CategoryDefinitions table."] = "数据是分类的而不是连续的，根据类别定义表中的类别进行数据绘图。";
 $lang["db_Constant Over Interval"] = "恒定值";
 $lang["db_The values are quantities that can be interpreted as constant for all time, or over the time interval to a subsequent measurement of the same variable at the same site."] = "同一场地的同一变量在所有时间或某时间间隔内数值保持恒定。";
 $lang["db_Continuous"] = "连续的";
 $lang["db_A quantity specified at a particular instant in time measured with sufficient frequency small spacing) to be interpreted as a continuous record of the phenomenon."] = "在足够小的时间间隔获得的即时测量数据被视为对该现象的连续记录。";
 $lang["db_Cumulative"] = "累积的";
 $lang["db_The values represent the cumulative value of a variable measured or calculated up to a given instant of time, such as cumulative volume of flow or cumulative precipitation."] = "此数据代表某一变量在给定时间内的累积值，如累积体积流量或累积降水。";
 $lang["db_Incremental"] = "增量";
 $lang["db_The values represent the incremental value of a variable over a time interval, such as the incremental volume of flow or incremental precipitation."] = "此数据代表某一变量在给定时间内的增量，如体积流量增量或降水增量。";
 $lang["db_Maximum"] = "最大值";
 $lang["db_The values are the maximum values occurring at some time during a time interval, such as annual maximum discharge or a daily maximum air temperature."] = "某一时间间隔内数据的最大值，例如年最大排放量或日大气最高温度。";
 $lang["db_Median"] = "中值";
 $lang["db_The values represent the median over a time interval, such as daily median discharge or daily median temperature."] = "某一时间间隔内数据的中位数，例如日排放中值或日温度中值。";
 $lang["db_Minimum"] = "最小值";
 $lang["db_The values are the minimum values occurring at some time during a time interval, such as 7-day low flow for a year or the daily minimum temperature."] = "某一时间间隔内数据的最小值，例如年7天最低流量或年/日最低温度。";
 $lang["db_Mode"] = "众数";
 $lang["db_The values are the most frequent values occurring at some time during a time interval, such as annual most frequent wind direction."] = "某一时间间隔内出现频率最高的数值，例如年最高频率风向。";
 $lang["db_Sporadic"] = "分散";
 $lang["db_The phenomenon is sampled at a particular instant in time but with a frequency that is too coarse for interpreting the record as continuous. This would be the case when the spacing is significantly larger than the support and the time scale of fluctuation of the phenomenon, such as for example infrequent water quality samples."] = "在特定时刻采集样品，但采样频率太粗糙而不能称为连续采样，即采样间隔明显比所观察对象波动的时间尺度大，例如低频率水质样品。";
 $lang["db_StandardDeviation"] = "标准差";
 $lang["db_The values represent the standard deviation of a set of observations made over a time interval. Standard deviation computed using the unbiased formula SQRTSUMXi-mean)^2)/n-1)) are preferred. The specific formula used to compute variance can be noted in the methods description."] = "某一时间间隔内数据的标准差，标准差计算公式建议使用 SQRT(SUM((Xi-mean)^2)/(n-1))，如果使用其他公式计算请备注。";
 $lang["db_Unknown"] = "未知";
 $lang["db_The data type is unknown"] = "数据格式未知";
 $lang["db_Variance"] = "方差";
 $lang["db_The values represent the variance of a set of observations made over a time interval. Variance computed using the unbiased formula SUMXi-mean)^2)/n-1) are preferred. The specific formula used to compute variance can be noted in the methods description."] = "某一时间间隔内数据的方差，方差计算公式推荐使用SUM((Xi-mean)^2)/(n-1)，使用其他公式计算请备注。";
 $lang["db_Biota"] = "生物";
 $lang["db_Data associated with biological organisms"] = "与生物有机体有关的数据";
 $lang["db_Climate"] = "气候";
 $lang["db_Data associated with the climate, weather, or atmospheric processes"] = "与气候、天气或大气过程有关的数据";
 $lang["db_Geology"] = "地质";
 $lang["db_Data associated with geology or geological processes"] = "与地质或地质过程有关的数据";
 $lang["db_Hydrology"] = "水文";
 $lang["db_Data associated with hydrologic variables or processes"] = "与水文变量或过程有关的数据";
 $lang["db_Instrumentation"] = "设备";
 $lang["db_Data associated with instrumentation and instrument properties such as battery voltages, data logger temperatures, often useful for diagnosis."] = "与设备使用和性能有关的数据，如电池电压、数据记录仪温度，通常用于设备诊断。";
 $lang["db_Unknown"] = "未知";
 $lang["db_The general category is unknown"] = "总类别未知";
 $lang["db_Water Quality"] = "水质";
 $lang["db_Data associated with water quality variables or processes"] = "与水质变量或过程相关的数据";
 $lang["db_-9999,"] = "-9999，";
 $lang["db_-9999"] = "-9999";
 $lang["db_Unknown"] = "未知";
 $lang["db_The quality control level is unknown"] = "质量标准未知";
 $lang["db_0,"] = "0，";
 $lang["db_0"] = "0";
 $lang["db_Raw data"] = "原始数据";
 $lang["db_Raw and unprocessed data and data products that have not undergone quality control. Depending on the variable, data type, and data transmission system, raw data may be available within seconds or minutes after the measurements have been made. Examples include real time precipitation, streamflow and water quality measurements."] = "未经过质量控制的原始/未处理数据，根据变量类型、数据类型和数据传输系统，原始数据可以在几秒钟或几秒钟内获得，例如实时降水量、水流量和水质监测数据。";
 $lang["db_1,"] = "1，";
 $lang["db_1"] = "1";
 $lang["db_Quality controlled data"] = "质量受控数据";
 $lang["db_Quality controlled data that have passed quality assurance procedures such as routine estimation of timing and sensor calibration or visual inspection and removal of obvious errors. An example is USGS published streamflow records following parsing through USGS quality control procedures."] = "质量受控数据指经过质量控制过程的数据，如常规时间估算、传感器校准或检查和明显错误的排除，例如，USGS根据USGE质控过程分析得到的水流记录。";
 $lang["db_2,"] = "2，";
 $lang["db_2"] = "2";
 $lang["db_Derived products"] = "衍生数据";
 $lang["db_Derived products that require scientific and technical interpretation and may include multiple-sensor data. An example is basin average precipitation derived from rain gages using an interpolation procedure."] = "衍生数据要求科学的和技术的演算，可能包括多传感器数据，例如，流域平均降水量由多个降雨数据插值获得。";
 $lang["db_3,"] = "3，";
 $lang["db_3"] = "3";
 $lang["db_Interpreted products"] = "解析结果";
 $lang["db_Interpreted products that require researcher driven analysis and interpretation, model-based interpretation using other data and/or strong prior assumptions. An example is basin average precipitation derived from the combination of rain gages and radar return data."] = "解析数据要求研究人员进行分析和解析、使用其他数据或假定条件基于模型的解析。例如，使用雨量计数据与雷达回波数据联合计算流域平均降雨量。";
 $lang["db_4,"] = "4，";
 $lang["db_4"] = "4";
 $lang["db_Knowledge products"] = "知识结果";
 $lang["db_Knowledge products that require researcher driven scientific interpretation and multidisciplinary data integration and include model-based interpretation using other data and/or strong prior assumptions. An example is percentages of old or new water in a hydrograph inferred from an isotope analysis."] = "知识结果要求研究人员进行科学解析和多学科数据的整合，包括进行使用其他数据或假定条件的基于模型的解析。例如，通过同位素分析获得水位图中新、旧水的百分比。";
 $lang["db_Air"] = "大气";
 $lang["db_Sample taken from the atmosphere"] = "大气中采集的样品";
 $lang["db_Flowback water"] = "回流水";
 $lang["db_A mixture of formation water and hydraulic fracturing injectates deriving from oil and gas wells prior to placing wells into production"] = "石油或天然气井投入生产前，水力压裂注射和地层水形成的混合物。";
 $lang["db_Groundwater"] = "地下水";
 $lang["db_Sample taken from water located below the surface of the ground, such as from a well or spring"] = "地表以下采集的水样，如从井中或泉水";
 $lang["db_Municipal waste water"] = "城市污水";
 $lang["db_Sample taken from raw municipal waste water stream."] = "城市污水管道中采集的水样。";
 $lang["db_Not Relevant"] = "无关";
 $lang["db_Sample medium not relevant in the context of the measurement"] = "样品介质与测量无关";
 $lang["db_Other"] = "其他";
 $lang["db_Sample medium other than those contained in the CV"] = "其他样品介质";
 $lang["db_Precipitation"] = "降水";
 $lang["db_Sample taken from solid or liquid precipitation"] = "样品采集于固体或液体降水";
 $lang["db_Production water"] = "生产污水";
 $lang["db_Fluids produced from wells during oil or gas production which may include formation water, injected fluids, oil and gas."] = "石油或天然气生产过程中产生的液体，可能包含地层水、注射液体、石油和气体。";
 $lang["db_Sediment"] = "底泥";
 $lang["db_Sample taken from the sediment beneath the water column"] = "水体中的底泥样品";
 $lang["db_Snow"] = "雪";
 $lang["db_Observation in, of or sample taken from snow"] = "降雪观测数据或雪样品";
 $lang["db_Soil"] = "土壤";
 $lang["db_Sample taken from the soil"] = "从土壤中采集的样品";
 $lang["db_Soil air"] = "土壤气";
 $lang["db_Air contained in the soil pores"] = "土壤孔隙中的气体";
 $lang["db_Soil water"] = "土壤水";
 $lang["db_the water contained in the soil pores"] = "土壤孔隙中的水";
 $lang["db_Surface Water"] = "地表水";
 $lang["db_Observation or sample of surface water such as a stream, river, lake, pond, reservoir, ocean, etc."] = "地表水的观测值或样品，例如河流、溪流、湖泊、水库、海洋等";
 $lang["db_Tissue"] = "生物组织";
 $lang["db_Sample taken from the tissue of a biological organism"] = "生物机体组织上采集的样品";
 $lang["db_Unknown"] = "未知";
 $lang["db_The sample medium is unknown"] = "样品介质未知";
 $lang["db_Automated"] = "自动化";
 $lang["db_Sample collected using an automated sampler"] = "样品使用自动化采样设备采集";
 $lang["db_FD"] = "FD";
 ...
 $lang["db_Grab"] = "随机采样";
 $lang["db_Grab sample"] = "随机样品";
 $lang["db_GW"] = "GW";
 $lang["db_Groundwater"] = "地下水";
 $lang["db_LF"] = "LF";
 $lang["db_Litter Fall Digestion"] = "Litter Fall Digestion";
 $lang["db_meteorological"] = "气象";
 $lang["db_sample type can include a number of measured sample types including temperature, RH, solar radiation, precipitation, wind speed, wind direction."] = "样品类型包括温度、RH、太阳辐射、降水、风速、风向";
 $lang["db_No Sample"] = "无样品";
 $lang["db_There is no lab sample associated with this measurement"] = "无样品使用该方法";
 $lang["db_PB"] = "PB";
 $lang["db_Precipitation Bulk"] = "降水体积";
 $lang["db_PD"] = "PD";
 $lang["db_Petri Dish Dry Deposition)"] = "培养皿干沉降）";
 $lang["db_PE"] = "PE";
 $lang["db_Precipitation Event"] = "降水事件";
 $lang["db_PI"] = "PI";
 $lang["db_Precipitation Increment"] = "降水增量";
 $lang["db_PW"] = "PW";
 $lang["db_Precipitation Weekly"] = "周降水量";
 $lang["db_RE"] = "RE";
 $lang["db_Rock Extraction"] = "矿石提取";
 $lang["db_SE"] = "SE";
 $lang["db_Stemflow Event"] = "树干茎流事件";
 $lang["db_SR"] = "SR";
 $lang["db_Standard Reference"] = "参考标准";
 $lang["db_SS"] = "SS";
 $lang["db_Streamwater Suspended Sediment"] = "溪流悬移质泥沙";
 $lang["db_SW"] = "SW";
 $lang["db_Streamwater"] = "溪流";
 $lang["db_TE"] = "TE";
 $lang["db_Throughfall Event"] = "贯穿降水量";
 $lang["db_TI"] = "TI";
 $lang["db_Throughfall Increment"] = "贯穿降水量增量";
 $lang["db_TW"] = "TW";
 $lang["db_Throughfall Weekly"] = "周贯穿降水量";
 $lang["db_Unknown"] = "未知";
 $lang["db_The sample type is unknown"] = "样品类型未知";
 $lang["db_VE"] = "VE";
 $lang["db_Vadose Water Event"] = "渗流量";
 $lang["db_VI"] = "VI";
 $lang["db_Vadose Water Increment"] = "渗流增量";
 $lang["db_VW"] = "VW";
 $lang["db_Vadose Water Weekly"] = "周渗流量";
