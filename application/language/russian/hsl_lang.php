<?php
 $lang['hsl_Abstract'] = "Конспект";
 $lang['hsl_AddNewUser'] = "Добавьте Нового Пользователя";
 $lang['hsl_Address'] = "Адрес:";
 $lang['hsl_AddUser'] = "Добавьте Пользователя";
 $lang['hsl_Another'] = "Хотите ещё?";
 $lang['hsl_Administrator'] = "Администратор";
 $lang['hsl_AreYouSure'] = "Вы уверены?";
 $lang['hsl_Authority'] = "Авторитет:";
 $lang['hsl_Cancel'] = "Отменить";
 $lang['hsl_CaseSensitive'] = "(Прописные важны Напишите 6-8 букв)";
 $lang['hsl_Category'] = "Категория:";
 $lang['hsl_CategoryDefinition'] = "Определение категории:";
 $lang['hsl_ChangeAuthorityButton'] = "Изменить авторитет";
 $lang['hsl_ChangePassword'] = "Изменить пароль";
 $lang['hsl_ChangeUserAuthority'] = "Изменить авторитет пользователя";
 $lang['hsl_ChangeUserPassword'] = "Изменить пароль пользователя";
 $lang['hsl_Citation'] = "Библиография";
 $lang['hsl_City'] = "Город:";
 $lang['hsl_Comments'] = "Коментарий:";
 $lang['hsl_ConfirmationBox'] = "Коробка подтверждения";
 $lang['hsl_ContactName'] = "Имя контакта";
 $lang['hsl_County'] = "Область:";
 $lang['hsl_CountyEllipsis'] = "Область...";
 $lang['hsl_DataType'] = "Тип данных";
 $lang['hsl_DataTypeDefinition'] = "Определение типа данных";
 $lang['hsl_Date'] = "Число:";
 $lang['hsl_Delete'] = "Убирать";
 $lang['hsl_Description'] = "Описание";
 $lang['hsl_Elevation'] = "Высота";
 $lang['hsl_Email'] = "Электронная почта";
 $lang['hsl_ExAbstract'] = "(Пример: Мосс собирает водные данные из Пондероса Стейт Парк...или вы можете написать Неизвестный)";
 $lang['hsl_ExAbstract1'] = "(Пример: Студенты в средней школе/учёные собирая...)";
 $lang['hsl_ExCitation'] = "(Необязательный: Пример: Данные собраные учёными МОССа и другими учёными...)";
 $lang['hsl_ExDescript'] = "(Пример: Цель МОССА...)";
 $lang['hsl_ExEmail'] = "(Пример: info@moss.org)";
 $lang['hsl_ExMetaLink'] = "(Необязательный: Пример: http://www.mossidaho.org)";
 $lang['hsl_ExMethodLink'] = "(Необязательный: Пример: http://www.ysi.com/productsdetail.php?DO200-35)";
 $lang['hsl_ExName'] = "(Полная имя)";
 $lang['hsl_ExPhone'] = "(Пример: XXX-XXX-XXXX)";
 $lang['hsl_ExProfileVersion'] = "(Пример: ISO8601 или вы можете написать Неизвестный)";
 $lang['hsl_ExSiteCode'] = "(Можете исправлять это если нужно)";
 $lang['hsl_ExSiteName'] = "(Пример: \"какое-то место\")";
 $lang['hsl_ExSitePhoto'] = "(Фото должно быть формат .JPG файл и будет загружен при представлении внизу)";
 $lang['hsl_OrganizationNameEx'] = "(Пример: Университет Ломоносова)";
 $lang['hsl_ExTitle2'] = "(Пример: Университет Ломоносова)";
 $lang['hsl_Fifty'] = "50 км";
 $lang['hsl_FindSites'] = "Найдите сайты близко ко мне!";
 $lang['hsl_FirstName'] = "Первое имя";
 $lang['hsl_FirstLastNameExample'] = "(Первая буква и фамиля Пример: \"сиванов\" -Сергей Иванов)";
 $lang['hsl_FiveHundred'] = "500 км";
